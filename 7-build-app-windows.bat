...
call reportgenerator "-title:personal-finance Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:personal-finance Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for personal-finance
call OpenCppCoverage.exe --export_type=binary:personal-finance_tests_unit_win.cov --sources src\personal-finance\src --sources src\personal-finance\header --sources src\tests\personal-finance -- build_win\build\Debug\personal-finance_tests.exe

echo Generate Test Coverage Data for personal-finance App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=personal-finance_tests_unit_win.cov --export_type=cobertura:personal-financeapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\personal-finance\src --sources src\personal-finance\header --sources src\personal-financeapp\src --sources src\personal-financeapp\header --sources src\tests\utility --sources src\tests\personal-finance -- build_win\build\Debug\personal-financeapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:personal-finance Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/personal-financeapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/personal-finance/src;src/personal-finance/header;src/personal-financeapp/src;src/personal-financeapp/header;src/tests/utility;src/tests/personal-finance" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/personal-financeapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/personal-finance/src;src/personal-finance/header;src/personal-financeapp/src;src/personal-financeapp/header;src/tests/utility;src/tests/personal-finance" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
