 ...
 * @brief Fallback SHA256 Implementasyonu (OpenSSL olmadığında kullanılır)
 * 
 * Bu header-only implementasyon, OpenSSL yoksa kullanılır.
 * Küçük, güvenilir ve standalone SHA256 algoritması.
 * 
 * NOT: Production için OpenSSL kullanılması önerilir.
 */
    ...
    namespace personal {
        namespace rasp {
            namespace detail {
                ...
                /**
                 * @brief SHA256 için kullanılan sabitler (K constants)
                 */
                 ...
                 * @return SHA256 hash değeri (hex string, 64 karakter)
                 */
